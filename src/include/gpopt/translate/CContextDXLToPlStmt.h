...
namespace gpdxl
{
	...
	class CContextDXLToPlStmt
	{
		private:
			...
			std::vector<Bitmapset *> m_static_prune_results;
		...
		public:
			...
			Bitmapset *GetStaticPruneResult(ULONG scanId);
			void SetStaticPruneResult(ULONG scanId, Bitmapset *static_prune_result);
